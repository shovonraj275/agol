...
<!-- Video Section Two -->
<section class="video-section" style="background-image: url(<?php echo get_theme_mod('agol_videos_set_con_bg'); ?>)">
	<div class="auto-container">
		<div class="content">
			<h2>Drive Now <span>Pay Later with Easy</span></h2>
			<div class="text">
				<p><?php echo get_theme_mod('agol_videos_set_con_dscription') ?></p>
			</div>
			<a href="<?php echo get_theme_mod('agol_videos_set_con_link') ?>" class="lightbox-image video-box"><span class="fa fa-play"><i class="ripple"></i></span></a>
		</div>
	</div>
</section>
			...
			<div class="inner-box">
				<div class="clearfix">
					...
					<div class="image-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<div class="image">
								<img src="<?php echo get_theme_mod('agol_feature_work_set_con_one_images') ?>" alt="" />
							</div>
						</div>
					</div>
					...
					<div class="content-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<h5><a href="projects-detail.html"><?php echo get_theme_mod('agol_feature_work_set_con_one_heading') ?> </a></h5>
							<div class="text">
								<p><?php echo get_theme_mod('agol_feature_work_set_con_one_description') ?> </p>
							</div>
			...
			<div class="inner-box">
				<div class="clearfix">
					...
					<div class="image-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<div class="image">
								<img src="<?php echo get_theme_mod('agol_feature_work_set_con_two_images') ?>" alt="" />
							</div>
						</div>
					</div>
					...
					<div class="content-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<h5><a href="projects-detail.html"><?php echo get_theme_mod('agol_feature_work_set_con_two_heading') ?> </a></h5>
							<div class="text">
								<p><?php echo get_theme_mod('agol_feature_work_set_con_two_description') ?> </p>
							</div>
							<a class="read-more" href="projects-detail.html">Read More <span class="fa fa-long-arrow-right"></span></a>
						</div>
					</div>
		...
		<div class="featured-block col-lg-6 col-md-12 col-sm-12">
			<div class="inner-box">
				<div class="clearfix">
					...
					<div class="content-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<h5><a href="projects-detail.html"><?php echo get_theme_mod('agol_feature_work_set_con_three_heading') ?> </a></h5>
							<div class="text">
								<p><?php echo get_theme_mod('agol_feature_work_set_con_three_description') ?> </p>
							</div>
							<a class="read-more" href="projects-detail.html">Read More <span class="fa fa-long-arrow-right"></span></a>
						</div>
					</div>
					...
					<div class="image-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<div class="image">
								<img src="<?php echo get_theme_mod('agol_feature_work_set_con_three_images') ?>" alt="" />
							</div>
						</div>
					</div>
		...
		<div class="featured-block col-lg-6 col-md-12 col-sm-12">
			<div class="inner-box">
				<div class="clearfix">
					...
					<div class="content-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<h5><a href="projects-detail.html"><?php echo get_theme_mod('agol_feature_work_set_con_four_heading') ?> </a></h5>
							<div class="text">
								<p><?php echo get_theme_mod('agol_feature_work_set_con_four_description') ?> </p>
							</div>
							<a class="read-more" href="projects-detail.html">Read More <span class="fa fa-long-arrow-right"></span></a>
						</div>
					</div>
					...
					<div class="image-column col-lg-6 col-md-6 col-sm-12">
						<div class="inner-column">
							<div class="image">
								<img src="<?php echo get_theme_mod('agol_feature_work_set_con_four_images') ?>" alt="" />
							</div>
						</div>
					</div>
	...
	<div class="auto-container">
		...
		<div class="row clearfix">
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_one'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_two'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_three'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_four'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_five'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_six'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_seven'); ?>" alt="" /></a>
				</div>
			</div>
			...
			<div class="client-box col-lg-3 col-md-6 col-sm-12">
				<div class="image">
					<a href="#"><img src="<?php echo get_theme_mod('agol_brands_set_con_eight'); ?>" alt="" /></a>
				</div>
			</div>
